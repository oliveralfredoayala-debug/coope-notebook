(function() {
  ...
  var isHome = path === '/' || path === '/index.html' || (path.endsWith('/index.html') && !path.includes('/contents/') && !path.includes('/tools/') && !path.includes('/gow/') && !path.includes('/lnl/') && !path.includes('/kb/'));
